...
export class OcamlParser extends Parser {
	...
	public expr(_p?: number): ExprContext {
		...
		try {
			...
			case 10:
				...
				this.match(OcamlParser.T__23);
				this.state = 105;
				(_localctx as LambdaContext)._body = this.expr(6);
				}
				break;
			...
			case 11:
				...
				this.state = 112;
				(_localctx as LetExprContext)._in_context = this.expr(4);
				}
				break;

			case 12:
				{
				_localctx = new GlobalLetExprContext(_localctx);
				this._ctx = _localctx;
				_prevctx = _localctx;
				this.state = 114;
				this.match(OcamlParser.T__38);
				this.state = 115;
				(_localctx as GlobalLetExprContext)._name = this.pattern();
				this.state = 116;
				this.match(OcamlParser.T__6);
				this.state = 117;
				(_localctx as GlobalLetExprContext)._binding = this.expr(3);
				}
				break;
			...
			case 13:
				...
				this.state = 121;
				(_localctx as LetRecExprContext)._name = this.pattern();
				this.state = 122;
				this.match(OcamlParser.T__6);
				this.state = 123;
				(_localctx as LetRecExprContext)._binding = this.expr(0);
				this.state = 124;
				this.match(OcamlParser.T__39);
				this.state = 125;
				(_localctx as LetRecExprContext)._in_context = this.expr(2);
				}
				break;

			case 14:
				{
				_localctx = new GlobalLetRecExprContext(_localctx);
				this._ctx = _localctx;
				_prevctx = _localctx;
				this.state = 127;
				this.match(OcamlParser.T__38);
				...
				this.match(OcamlParser.T__40);
				this.state = 129;
				(_localctx as GlobalLetRecExprContext)._name = this.pattern();
				this.state = 130;
				this.match(OcamlParser.T__6);
				this.state = 131;
				(_localctx as GlobalLetRecExprContext)._binding = this.expr(1);
				}
				break;
			}
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					case 1:
						...
						this.state = 137;
						(_localctx as BinaryOpContext)._right = this.expr(12);
						}
						break;
					...
					case 2:
						...
						this.state = 141;
						(_localctx as ExprSemicolonExprContext)._second = this.expr(8);
						}
						break;
					...
					case 3:
						...
						this.state = 143;
						(_localctx as ApplicationContext)._argument = this.expr(6);
						}
						break;
					}
					}
	...
	public static readonly _serializedATN: string =
		...
		"\v\x03\v\x03\v\x06\vg\n\v\r\v\x0E\vh\x03\v\x03\v\x03\v\x03\v\x03\v\x03" +
		"\v\x03\v\x03\v\x03\v\x03\v\x03\v\x03\v\x03\v\x03\v\x03\v\x03\v\x03\v\x03" +
		"\v\x03\v\x03\v\x03\v\x03\v\x03\v\x03\v\x03\v\x03\v\x03\v\x03\v\x03\v\x05" +
		"\v\x88\n\v\x03\v\x03\v\x03\v\x03\v\x03\v\x03\v\x03\v\x03\v\x03\v\x07\v" +
		"\x93\n\v\f\v\x0E\v\x96\v\v\x03\f\x03\f\x03\f\x02\x02\x03\x14\r\x02\x02" +
		"\x04\x02\x06\x02\b\x02\n\x02\f\x02\x0E\x02\x10\x02\x12\x02\x14\x02\x16" +
		"\x02\x02\x05\x04\x02\x05\x1844\x03\x02\x1B\x1C\x03\x02%&\x02\xA8\x02\x1D" +
		"\x03\x02\x02\x02\x04!\x03\x02\x02\x02\x06#\x03\x02\x02\x02\b%\x03\x02" +
		"\x02\x02\n2\x03\x02\x02\x02\f4\x03\x02\x02\x02\x0E6\x03\x02\x02\x02\x10" +
		"8\x03\x02\x02\x02\x12?\x03\x02\x02\x02\x14\x87\x03\x02\x02\x02\x16\x97" +
		"\x03\x02\x02\x02\x18\x1E\x07.\x02\x02\x19\x1A\x07\x03\x02\x02\x1A\x1B" +
		"\x05\x04\x03\x02\x1B\x1C\x07\x04\x02\x02\x1C\x1E\x03\x02\x02\x02\x1D\x18" +
		"\x03\x02\x02\x02\x1D\x19\x03\x02\x02\x02\x1E\x03\x03\x02\x02\x02\x1F\"" +
		"\x075\x02\x02 \"\x05\x06\x04\x02!\x1F\x03\x02\x02\x02! \x03\x02\x02\x02" +
		"\"\x05\x03\x02\x02\x02#$\t\x02\x02\x02$\x07\x03\x02\x02\x02%&\x07\x19" +
		"\x02\x02&\'\x07/\x02\x02\'(\x05\n\x06\x02(\t\x03\x02\x02\x02)*\x07\x05" +
		"\x02\x02*+\x05\b\x05\x02+,\x05\n\x06\x02,3\x03\x02\x02\x02-.\x07\x1A\x02" +
		"\x02./\x05\b\x05\x02/0\x05\n\x06\x0203\x03\x02\x02\x0213\x03\x02\x02\x02" +
		"2)\x03\x02\x02\x022-\x03\x02\x02\x0221\x03\x02\x02\x023\v\x03\x02\x02" +
		"\x0245\x070\x02\x025\r\x03\x02\x02\x0267\t\x03\x02\x027\x0F\x03\x02\x02" +
		"\x0289\x071\x02\x029\x11\x03\x02\x02\x02:@\x05\x02\x02\x02;@\x07\x1D\x02" +
		"\x02<@\x05\f\x07\x02=@\x05\x0E\b\x02>@\x05\x10\t\x02?:\x03\x02\x02\x02" +
		"?;\x03\x02\x02\x02?<\x03\x02\x02\x02?=\x03\x02\x02\x02?>\x03\x02\x02\x02" +
		"@\x13\x03\x02\x02\x02AB\b\v\x01\x02B\x88\x05\x02\x02\x02C\x88\x05\f\x07" +
		"\x02D\x88\x05\x0E\b\x02E\x88\x05\x10\t\x02FG\x07\x03\x02\x02GH\x05\x14" +
		"\v\x02HI\x07\x04\x02\x02I\x88\x03\x02\x02\x02JK\x075\x02\x02K\x88\x05" +
		"\x14\v\x0ELM\x07\x1E\x02\x02MN\x05\x14\v\x02NO\x07\x1F\x02\x02OR\x05\x14" +
		"\v\x02PQ\x07 \x02\x02QS\x05\x14\v\x02RP\x03\x02\x02\x02RS\x03\x02\x02" +
		"\x02S\x88\x03\x02\x02\x02TU\x07!\x02\x02UV\x05\x14\v\x02VW\x07\"\x02\x02" +
		"WX\x05\x14\v\x02XY\x07#\x02\x02Y\x88\x03\x02\x02\x02Z[\x07$\x02\x02[\\" +
		"\x05\x02\x02\x02\\]\x07\t\x02\x02]^\x05\x14\v\x02^_\t\x04\x02\x02_`\x05" +
		"\x14\v\x02`a\x07\"\x02\x02ab\x05\x14\v\x02bc\x07#\x02\x02c\x88\x03\x02" +
		...
		"\x02kl\x05\x14\v\bl\x88\x03\x02\x02\x02mn\x07)\x02\x02no\x05\x12\n\x02" +
		"op\x07\t\x02\x02pq\x05\x14\v\x02qr\x07*\x02\x02rs\x05\x14\v\x06s\x88\x03" +
		"\x02\x02\x02tu\x07)\x02\x02uv\x05\x12\n\x02vw\x07\t\x02\x02wx\x05\x14" +
		"\v\x05x\x88\x03\x02\x02\x02yz\x07)\x02\x02z{\x07+\x02\x02{|\x05\x12\n" +
		"\x02|}\x07\t\x02\x02}~\x05\x14\v\x02~\x7F\x07*\x02\x02\x7F\x80\x05\x14" +
		"\v\x04\x80\x88\x03\x02\x02\x02\x81\x82\x07)\x02\x02\x82\x83\x07+\x02\x02" +
		"\x83\x84\x05\x12\n\x02\x84\x85\x07\t\x02\x02\x85\x86\x05\x14\v\x03\x86" +
		"\x88\x03\x02\x02\x02\x87A\x03\x02\x02\x02\x87C\x03\x02\x02\x02\x87D\x03" +
		"\x02\x02\x02\x87E\x03\x02\x02\x02\x87F\x03\x02\x02\x02\x87J\x03\x02\x02" +
		"\x02\x87L\x03\x02\x02\x02\x87T\x03\x02\x02\x02\x87Z\x03\x02\x02\x02\x87" +
		"d\x03\x02\x02\x02\x87m\x03\x02\x02\x02\x87t\x03\x02\x02\x02\x87y\x03\x02" +
		"\x02\x02\x87\x81\x03\x02\x02\x02\x88\x94\x03\x02\x02\x02\x89\x8A\f\r\x02" +
		"\x02\x8A\x8B\x05\x06\x04\x02\x8B\x8C\x05\x14\v\x0E\x8C\x93\x03\x02\x02" +
		"\x02\x8D\x8E\f\t\x02\x02\x8E\x8F\x07\'\x02\x02\x8F\x93\x05\x14\v\n\x90" +
		"\x91\f\x07\x02\x02\x91\x93\x05\x14\v\b\x92\x89\x03\x02\x02\x02\x92\x8D" +
		"\x03\x02\x02\x02\x92\x90\x03\x02\x02\x02\x93\x96\x03\x02\x02\x02\x94\x92" +
		"\x03\x02\x02\x02\x94\x95\x03\x02\x02\x02\x95\x15\x03\x02\x02\x02\x96\x94" +
		"\x03\x02\x02\x02\x97\x98\x05\x12\n\x02\x98\x17\x03\x02\x02\x02\v\x1D!" +
		"2?Rh\x87\x92\x94";
...
export class GlobalLetExprContext extends ExprContext {
	public _name!: PatternContext;
	public _binding!: ExprContext;
	public pattern(): PatternContext {
		return this.getRuleContext(0, PatternContext);
	...
	// @Override
	public enterRule(listener: OcamlListener): void {
		if (listener.enterGlobalLetExpr) {
			listener.enterGlobalLetExpr(this);
		}
	}
	// @Override
	public exitRule(listener: OcamlListener): void {
		if (listener.exitGlobalLetExpr) {
			listener.exitGlobalLetExpr(this);
		}
	}
	// @Override
	public accept<Result>(visitor: OcamlVisitor<Result>): Result {
		if (visitor.visitGlobalLetExpr) {
			return visitor.visitGlobalLetExpr(this);
		} else {
			return visitor.visitChildren(this);
		}
	}
}
export class LetRecExprContext extends ExprContext {
	public _name!: PatternContext;
	public _binding!: ExprContext;
	public _in_context!: ExprContext;
	public pattern(): PatternContext {
	...
	// @Override
	public enterRule(listener: OcamlListener): void {
		if (listener.enterLetRecExpr) {
			listener.enterLetRecExpr(this);
		}
	}
	// @Override
	public exitRule(listener: OcamlListener): void {
		if (listener.exitLetRecExpr) {
			listener.exitLetRecExpr(this);
		}
	}
	// @Override
	public accept<Result>(visitor: OcamlVisitor<Result>): Result {
		if (visitor.visitLetRecExpr) {
...
export class GlobalLetRecExprContext extends ExprContext {
	public _name!: PatternContext;
	public _binding!: ExprContext;
	public pattern(): PatternContext {
		return this.getRuleContext(0, PatternContext);
	...
	// @Override
	public enterRule(listener: OcamlListener): void {
		if (listener.enterGlobalLetRecExpr) {
			listener.enterGlobalLetRecExpr(this);
		}
	}
	// @Override
	public exitRule(listener: OcamlListener): void {
		if (listener.exitGlobalLetRecExpr) {
			listener.exitGlobalLetRecExpr(this);
		}
	}
	// @Override
	public accept<Result>(visitor: OcamlVisitor<Result>): Result {
		if (visitor.visitGlobalLetRecExpr) {
			return visitor.visitGlobalLetRecExpr(this);
		} else {
			return visitor.visitChildren(this);
		}
	}
